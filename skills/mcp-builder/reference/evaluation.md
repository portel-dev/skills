...
After creating your evaluation file, you can run evaluations using any MCP-compatible client or the official Anthropic evaluation tools.
...
1. Connect your MCP server to Claude Desktop or another MCP client
2. Ask Claude the questions from your evaluation file
...
A good evaluation report should track:
...
- Check if input parameters are well-documented
- Consider whether tools return too much or too little data
- Ensure error messages are actionable

### Connection Issues

- Verify your MCP server is running correctly
- Check authentication is configured properly
- Test individual tools manually before running full evaluation